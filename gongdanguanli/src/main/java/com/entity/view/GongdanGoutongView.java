...
public class GongdanGoutongView extends GongdanGoutongEntity implements Serializable {
	...
	public GongdanGoutongView() {

	}

	public GongdanGoutongView(GongdanGoutongEntity gongdanGoutongEntity) {
		try {
			BeanUtils.copyProperties(this, gongdanGoutongEntity);
