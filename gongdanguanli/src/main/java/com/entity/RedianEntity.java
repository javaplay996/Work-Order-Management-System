 ...
 */
@TableName("redian")
public class RedianEntity<T> implements Serializable {
    ...
    public String toString() {
        return "Redian{" +
            "id=" + id +
            ", redianName=" + redianName +
            ", redianTypes=" + redianTypes +
            ", redianContent=" + redianContent +
            ", jiejueContent=" + jiejueContent +
