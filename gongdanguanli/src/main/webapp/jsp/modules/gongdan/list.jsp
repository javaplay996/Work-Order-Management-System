    ...
    <script>
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("gongdan/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addgongdan", "addgongdan");
            window.location.href = "add-or-update.jsp"
        }
