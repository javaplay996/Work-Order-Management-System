            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">工单受理登记</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <div class="form-group col-md-6">
                                    <label>工单状态</label>
                                    <input id="gongdanShenheValue" name="gongdanShenheValue" class="form-control"
                                           v-model="ruleForm.gongdanShenheValue" readonly>
                                </div>
...
<script>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "gongdanShouli/info/" + id,
    ...
    function setContent() {
        ...
        if (ruleForm.gongdanShouliContent != null && ruleForm.gongdanShouliContent != 'null' && ruleForm.gongdanShouliContent != '') {
            var gongdanShouliContentUeditor = UE.getEditor('gongdanShouliContentEditor');
                gongdanShouliContentUeditor.ready(function () {
                    var mes = '' + ruleForm.gongdanShouliContent;
                    gongdanShouliContentUeditor.setContent(mes);
                    gongdanShouliContentUeditor.setDisabled('fullscreen');
            });
        }
        if (ruleForm.gongdanPingjiaContent != null && ruleForm.gongdanPingjiaContent != 'null' && ruleForm.gongdanPingjiaContent != '') {
            var gongdanPingjiaContentUeditor = UE.getEditor('gongdanPingjiaContentEditor');
                gongdanPingjiaContentUeditor.ready(function () {
                    var mes = '' + ruleForm.gongdanPingjiaContent;
                    gongdanPingjiaContentUeditor.setContent(mes);
                    gongdanPingjiaContentUeditor.setDisabled('fullscreen');
            });
        }
    }
